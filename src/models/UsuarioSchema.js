...
const UserDTO = z.object({
  ...
  cpf: z.string().nonempty("CPF não pode estar vazio."),

  telefone: z.string().nonempty("Telefone não pode estar vazio."),

  genero: z.string().nonempty("Gênero não pode estar vazio."),
