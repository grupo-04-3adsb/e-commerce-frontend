...
function InfoUsuarios() {
  ...
  return (
    <div className="flex flex-col items-center py-8 px-4">
      <div className="flex w-full max-w-screen-xl flex-col shadow-lg rounded-xl p-8">
        <div className="w-full flex gap-10">
          <div className="relative flex flex-wrap items-center justify-center mb-8 md:mb-0">
            <Skeleton
              isLoaded={!loading}
              animated
              width={176}
